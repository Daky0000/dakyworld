...
const UPLOAD_PATHS = ["/api/website/sites", "/api/imports", "/api/settings/system/brand", "/api/emails/attachments", "/api/demos"];
...
// Central error handler. See middleware/errorHandler.ts.
