...
export const SCRAPER_TEMPLATES: ScraperTemplate[] = [
  ...
  },
  {
    ...
    preset: "GOOGLE_MAPS",
    leadSource: "GOOGLE_MAPS",
    groupName: "Manufacturing & distribution",
    maxItems: 100,
    minScore: 40,
    editFirst: ["searchStringsArray", "locationQuery"],
    input: {
